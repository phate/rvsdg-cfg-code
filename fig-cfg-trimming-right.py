...
make_edge(branch_c, lp0, origin_rel=0.2, origin_label='0', origin_label_orient=+1)
...
make_edge(branch_demux, p1, origin_label='0', origin_label_orient=-1)
make_edge(p1, exit, target_rel=0.3)

box_head = figure.base.box(surrounds = (a, branch_a), canvas = cv, pad = 0.1, style = figure.base.DASHED)
box_b1 = figure.base.box(surrounds = (c, branch_c, lp0, lp1, lnull), canvas = cv, pad = 0.1, style = figure.base.DASHED)
box_b2 = figure.base.box(surrounds = (b,rp1), canvas = cv, pad = 0.1, style = figure.base.DASHED)
box_tail = figure.base.box(surrounds = (branch_demux, p0, p1, exit), canvas = cv, pad = 0.1, style = figure.base.DASHED)
